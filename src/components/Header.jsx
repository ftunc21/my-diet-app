        ...
        <header className="header flex justify-between items-center p-5 bg-white shadow-md">
            ...
            <div className="flex-grow flex justify-end items-center">
                ...
                <Menu mode="horizontal" className="header-nav flex gap-4 text-orange-600">
                    ...
                    <Menu.Item key="4" onClick={() => navigate('/recipes')} className="hover:!text-orange-600 hover:after:!border-b-[#FF5722]" icon={<ReadOutlined />}>
                        Tarifler
                    </Menu.Item>
                    <Menu.Item key="5" onClick={() => navigate('/about-us')} className="hover:!text-orange-600 hover:after:!border-b-[#FF5722]" icon={<ReadOutlined />}>
                        Hakkımızda
                    </Menu.Item>
                </Menu>
                {user ? (
